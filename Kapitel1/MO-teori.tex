...
På samme måde som med $\sigma$-orbitalerne dannes $\pi$-orbitalerne ved, at to atomers befinder sig tæt på hinanden og elektronerne kan få en lavere energi ved at befinde sig i det sted hvor orbitalerne overlapper. Det græske bogstav $\pi$ refererer til p-orbitalerne. Dette er fordi $\pi$-orbitaler oftest ses dannet ud fra netop p-orbitaler, men det skal sige, at de også kan dannes ud fra d orbitaler. På figur (Mangler) ses hvordan 2 p-orbitaler går sammen om at danne en $\pi$-bindinger. 
\begin{center}
\begin{figure}[ht!]
  \centering
  \begin{tikzpicture}[scale=2]
